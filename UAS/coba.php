                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <img src="img/bg-img/AdaptiveGame-AI.jpg" alt="gambar_AdaptiveGame-AI.jpg">
                                <h3 data-animation="fadeInUp" data-delay="400ms">Wellcome to UDINUS</h3>
                                <h5 data-animation="fadeInUp" data-delay="100ms">AdaptiveGame-AI</h5>
            ...
            <div class="single-hero-slide">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <img src="img/bg-img/Biometric, Image Processing & Computer Vision.png"
                                    alt="gambar_Biometric, Image Processing & Computer Vision.png">
                                <h3 data-animation="fadeInUp" data-delay="400ms">Wellcome to TI Intelligent System
                                    Research</h3>
                                <h5 data-animation="fadeInUp" data-delay="100ms">Biometric, Image Processing & Computer
                                    Vision</h5>
                                <a href="#" class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms">Read
                                    More</a>
                            </div>
            ...
            <div class="single-hero-slide">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <img src="img/bg-img/Computational Intelligence & Fuzzy Logic.png"
                                    alt="Computational Intelligence & Fuzzy Logic.png">
                                <h3 data-animation="fadeInUp" data-delay="400ms">Wellcome to TI Intelligent System
                                    Research</h3>
                                <h5 data-animation="fadeInUp" data-delay="100ms">Computational Intelligence & Fuzzy
                                    Logic</h5>
                                <a href="#" class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms">Read
                                    More</a>
                            </div>
            ...
            <div class="single-hero-slide">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <img src="img/bg-img/Knowledge discovery in database & information retrieval.png"
                                    alt="gambar_Knowledge discovery in database & information retrieval.png">
                                <h3 data-animation="fadeInUp" data-delay="400ms">Wellcome to TI Intelligent System
                                    Research</h3>
                                <h5 data-animation="fadeInUp" data-delay="100ms">Knowledge discovery in database &
            ...
            <div class="single-hero-slide">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <img src="img/bg-img/Signal, Speech Recognition, Speech Synthesis & Natural Language Processing.png"
                                    alt="Signal, Speech Recognition, Speech Synthesis & Natural Language Processing.png">
                                <h3 data-animation="fadeInUp" data-delay="400ms">Wellcome to TI Intelligent System
                                    Research</h3>
                                <h5 data-animation="fadeInUp" data-delay="100ms">Signal, Speech Recognition, Speech
                                    Synthesis & Natural Language Processing</h5>
                                <a href="#" class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms">Read
                                    More</a>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp"
                        ...
                        <div class="popular-course-thumb bg-img" style="background-image: url(img/bg-img/pc-2.jpg);">
                        </div>
                    </div>
                </div>
