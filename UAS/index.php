                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <img src="img/desa-img/gambar1.jpg" alt="gambar_1.jpg">
                                <h3 data-animation="fadeInUp" data-delay="400ms">Welcome to Desa Hulosobo</h3>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="single-hero-slide">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <img src="img/desa-img/covid.jpg" alt="gambar_covid.jpg">
                                <h3 data-animation="fadeInUp" data-delay="400ms">Wajib Memakai Masker </h3>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="single-hero-slide">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <img src="img/desa-img/Rapat.jpeg" alt="gambar_Rapat.jpeg"> 
                                <h3 data-animation="fadeInUp" data-delay="400ms">Musyawarah Perencanaan dan Pembangunan Desa</h3>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="single-hero-slide">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <img src="img/desa-img/tari.jpg"
                                    alt="gambar_tari.jpg">
                                <h3 data-animation="fadeInUp" data-delay="400ms">Tarian Dolalak Mudolaras Desa Hulosobo</h3>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="single-hero-slide">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <img src="img/desa-img/gambar4.jpeg"
                                   alt="gambar_gambar4.jpeg">
                                <h3 data-animation="fadeInUp" data-delay="400ms">Buka Jalan yang Tertimbun Tanah Longsor</h3>
