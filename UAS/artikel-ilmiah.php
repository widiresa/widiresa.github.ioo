            ...
            <div class="align-content-center">
                <div class="col-12">
                    <div class="section-heading text-center mx-auto wow fadeInUp" data-wow-delay="300ms">
						...
						<div class="media">
                          <a href="https://jateng.inews.id/berita/berada-di-lereng-perbukitan-menoreh-desa-hulosobo-di-purworejo-gesit-hadapi-covid-19"><h4 class="media-heading">Berada di Lereng Perbukitan Menoreh, Desa Hulosobo di Purworejo Gesit Hadapi Covid-19</h4></a>
                          <a class="left" href="https://jateng.inews.id/berita/berada-di-lereng-perbukitan-menoreh-desa-hulosobo-di-purworejo-gesit-hadapi-covid-19"> 
						                                  <img class="media-object" src="img/desa-img/gambar3.jpg" width="260">
                              						  </a><br>
                          <div class="media-body" align="justify">
                            <p>Upaya penanganan pencegahan Covid-19 terus dilakukan sejumlah daerah. Bahkan, Desa Hulosobo di lereng Perbukitan Menoreh, Purworejo pun bergerak mengambil langkah cepat.</p>
                           </div>
                    </div>
